...
{
    [Serializable]
    public class DeletePlcParameterHistoryHandler : BaseCommandHandler, IRequestHandler<DeletePlcParameterHistoryCommand, OperationResult>// ICommandHandler<UpdatePlcParameterHistoryCommand>
    {
        public DeletePlcParameterHistoryHandler(IDbContext dbContext, IMapper mapper, IUserAccessor userAccessor)
            : base(dbContext, mapper, userAccessor)
        {
        }

        public async Task<OperationResult> Handle(DeletePlcParameterHistoryCommand command, CancellationToken cancellationToken)
        {
