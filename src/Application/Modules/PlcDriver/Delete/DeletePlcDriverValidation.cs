...
{
    [Serializable]
    public class DeletePlcDriverValidation : BaseValidation<DeletePlcDriverCommand>
    {
        public DeletePlcDriverValidation(IDbContext dbContext, IDefinitionModel definitionModel)
