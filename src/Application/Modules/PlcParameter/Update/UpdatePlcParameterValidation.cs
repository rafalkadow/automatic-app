...
{
    [Serializable]
    public class UpdatePlcParameterValidation : BaseValidation<UpdatePlcParameterCommand>
    {
        public UpdatePlcParameterValidation(IDbContext dbContext, IDefinitionModel definitionModel)
