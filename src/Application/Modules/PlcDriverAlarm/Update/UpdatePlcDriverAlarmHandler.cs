...
{
    [Serializable]
    public class UpdatePlcDriverAlarmHandler : BaseCommandHandler, IRequestHandler<UpdatePlcDriverAlarmCommand, OperationResult>
    {
        public UpdatePlcDriverAlarmHandler(IDbContext dbContext, IMapper mapper, IUserAccessor userAccessor)
            : base(dbContext, mapper, userAccessor)
        {
        }

        public async Task<OperationResult> Handle(UpdatePlcDriverAlarmCommand command, CancellationToken cancellationToken)
        {
