...
{
    [Serializable]
    public class BaseInactiveCommandHandler : BaseCommandHandler, IRequestHandler<BaseInactiveCommand, OperationResult>
    {
        ...
        public async Task<OperationResult> Handle(BaseInactiveCommand command, CancellationToken cancellationToken)
        {
