...
{
    [Serializable]
    public class BaseActiveCommandHandler : BaseCommandHandler, IRequestHandler<BaseActiveCommand, OperationResult>
    {
        ...
        public async Task<OperationResult> Handle(BaseActiveCommand command, CancellationToken cancellationToken)
        {
