...
{
    [Serializable]
    public class BaseArchiveCommandHandler : BaseCommandHandler, IRequestHandler<BaseArchiveCommand, OperationResult>
    {
        public BaseArchiveCommandHandler(IDbContext dbContext, IMapper mapper, IUserAccessor userAccessor)
            : base(dbContext, mapper, userAccessor)
        {
        }

        public async Task<OperationResult> Handle(BaseArchiveCommand command, CancellationToken cancellationToken)
        {
