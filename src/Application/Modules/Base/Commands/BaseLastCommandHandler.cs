...
{
    [Serializable]
    public class BaseLastCommandHandler : BaseCommandHandler, IRequestHandler<BaseLastCommand, OperationResult>
    {
        ...
        public async Task<OperationResult> Handle(BaseLastCommand command, CancellationToken cancellationToken)
        {
