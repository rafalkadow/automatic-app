...
{
    [Serializable]
    public class BaseUpCommandHandler : BaseCommandHandler, IRequestHandler<BaseUpCommand, OperationResult>
    {
        public BaseUpCommandHandler(IDbContext dbContext, IMapper mapper, IUserAccessor userAccessor)
            : base(dbContext, mapper, userAccessor)
        {
        }

        public async Task<OperationResult> Handle(BaseUpCommand command, CancellationToken cancellationToken)
        {
