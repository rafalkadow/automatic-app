...
namespace Persistence.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            UserManager<User> userManager, RoleManager<RoleApp> roleManager,
        ...
        public async Task<Result<TokenResponse>> GetRefreshTokenAsync(RefreshTokenRequest model)
        {
            ...
            var response = new TokenResponse { Token = token, RefreshToken = user.RefreshToken, RefreshTokenExpiryTime = user.RefreshTokenExpiryTime.Value };
            return await Result<TokenResponse>.SuccessAsync(response);
        }
