...
namespace Test.Application.Xunit.Handlers.DictionaryOfParameterCategory.Validation
{
    public class DictionaryOfParameterCategoryHandlerTestValidation : BaseHandlerBase
    {

        public DictionaryOfParameterCategoryHandlerTestValidation()
        : base()
        {
        }
        ...
        public void Validate_Error(string name, string code)
        {
            ...
            var model = new CreateDictionaryOfParameterCategoryCommand
            {
                Name = name,
                Code = code,
            };

            var validator = new CreateDictionaryOfParameterCategoryValidation(_dbContext, definitionModel);
